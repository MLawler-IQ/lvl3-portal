      ...
      {NAV_CARDS.map(({ href, icon: Icon, title, description }) => (
        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex h-9 w-9 items-center justify-center rounded-sm bg-surface-800 text-surface-400 transition-colors group-hover:bg-surface-700 group-hover:text-brand-400">
              <Icon size={18} strokeWidth={1.8} />
            </div>
            <ArrowRight size={14} className="text-surface-600 transition-colors group-hover:text-brand-400" />
          </div>
          <div>
