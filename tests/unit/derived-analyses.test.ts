...
const tornadoCrawl = tornado.crawl!.ok ? tornado.crawl!.data : { site: { robotsTxt: null, sitemapUrls: [], robotsTxtStatus: 'not-found' as const, llmsTxt: null, llmsTxtStatus: 'not-fetched' as const }, pages: [] }
const tornadoGsc: GSCRow[] = tornado.gsc!.ok ? tornado.gsc!.data : []
const healthyCrawl = healthy.crawl!.ok ? healthy.crawl!.data : { site: { robotsTxt: null, sitemapUrls: [], robotsTxtStatus: 'not-found' as const, llmsTxt: null, llmsTxtStatus: 'not-fetched' as const }, pages: [] }
